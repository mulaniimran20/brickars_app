...
class UtilitieRelateItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).pushNamed('/Utilities', arguments: new RouteArgument(argumentsList: [this.utilitie, this.heroTag], id: this.utilitie.id));
      },
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Container(
              ...
              height: 100,
              child: Hero(
                tag: this.heroTag + utilitie.id.toString(),
                child: Image.network(utilitie.image,fit: BoxFit.cover,),
              ),
            ),
            Column(
              mainAxisAlignment: MainAxisAlignment.start,
